...
import { useNavigate } from 'react-router-dom';
 ...
 const planetCards = [
  ...
  { id: 4, title: 'Rhythm Planet', path: '/rhythm', type: 'video', media: './PlanetMedia/Music.mp4', desc: 'Rhythm Planet is the second sub-planet of Passion. Unlike the bustling energy of its neighbors, this is a realm of profound and echoing melodies. Explorers reported that upon arriving, you become completely immersed in a serene symphony. The ancient, ruined architectures here serve as natural amplifiers for the wind and rustling leaves. The residents are deeply devoted to classical and instrumental music, especially the piano. The sounds here don\'t make you want to dance wildly; instead, they gently heal your soul and bring ultimate peace. That profound connection to sound is why it is named Rhythm.'},
      ...
      >
        ...
        <div className={`center-stage ${isExpanded ? 'expanded' : ''}`}>
          ...
          <div className="planet-info-panel" onClick={(e) => e.stopPropagation()}>
            ...
            <button className="explore-btn" onClick={() => navigate(planetCards[currentIndex].path)}>
                Explore
            </button>
          </div>
        </div>
